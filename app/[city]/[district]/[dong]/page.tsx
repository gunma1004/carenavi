...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // 🌟 동 단위 전용 순차적 인덱스 계산 (출장 배제, 겹침 원천 차단)
  const seed = `${locationKeyword}-dong-pure-seo`;
  ...
  const finalTitle = `${locationKeyword} ${dongModifiers[modIdx]}`;
  const finalDescription = `${locationKeyword} 마사지 샵 정보. ${dongDescriptions[descIdx]}`;
