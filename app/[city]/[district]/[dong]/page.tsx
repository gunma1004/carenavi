...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const titleVariants = [
    ...
    /* 10 */ `케어나비 | ${locationKeyword} 안심 힐링 마사지 테라피 공간`,
    ...
    /* 19 */ `케어나비 ${locationKeyword} 프리미엄 마사지 테라피 안내`,
    ...
    /* 25 */ `${locationKeyword} 전문 웰니스 마사지 샵 제휴 정보 - 케어나비`,
    /* 26 */ `${locationKeyword} 릴렉싱 아로마 마사지 테라피 프로그램`,
    /* 27 */ `케어나비 추천 ${locationKeyword} 맞춤 힐링 마사지 케어`,
    /* 28 */ `${locationKeyword} 편안한 휴식을 위한 전문 바디마사지 케어`,
    /* 29 */ `${locationKeyword} 최종 웰니스 마사지 테라피 제휴 가이드`
  ];

  const descriptionVariants = [
    /* 0 */ `${locationKeyword} 지역 프리미엄 힐링 테라피 및 마사지 제휴 샵 안내. 투명한 가격과 쾌적한 휴식 공간 정보를 케어나비에서 확인하세요.`,
    ...
    /* 10 */ `케어나비가 엄선한 ${locationKeyword} 안심 힐링 마사지 테라피 공간. 위생적이고 아늑한 제휴 샵 정보를 전해드립니다.`,
    ...
    /* 19 */ `케어나비 ${locationKeyword} 프리미엄 마사지 테라피 안내. 고객 만족도가 검증된 우수 제휴 샵 리스트입니다.`,
    ...
    /* 25 */ `전문 웰니스 마사지 샵 제휴 정보 - 케어나비. ${locationKeyword} 주민 여러분을 위한 힐링 가이드.`,
    /* 26 */ `${locationKeyword} 릴렉싱 아로마 마사지 테라피 프로그램. 고급 오일과 함께하는 깊은 이완의 시간.`,
    /* 27 */ `케어나비 추천 ${locationKeyword} 맞춤 힐링 마사지 케어. 엄선된 제휴처에서 품격 있는 휴식을 누려보세요.`,
...
export default async function DongMainPage({ params }: PageProps) {
  ...
  const shops = [
    { id: "1", name: `✨ ${fullLocation} 제휴 한국골든테라피`, desc: "고품격 릴렉싱 & 딥티슈 피로회복! 전문 테라피스트의 품격 있는 1:1 맞춤 마사지 케어", phone: "0507-1280-3361", price: "맞춤 코스별 상이", image: "/shop1.jpg" },
    { id: "2", name: `🌸 ${fullLocation} 제휴 한국미인테라피`, desc: "최고급 천연 오일을 활용한 감성 아로마 전신 바디마사지 프로그램", phone: "0507-1280-3303", price: "맞춤 코스별 상이", image: "/shop2.jpg" },
    { id: "3", name: `💎 ${fullLocation} 제휴 주주테라피`, desc: "재방문율 높은 만족도! 철저한 위생 관리와 프라이빗 힐링 바디마사지 서비스 제공", phone: "0507-1280-3193", price: "맞춤 코스별 상이", image: "/shop3.jpg" },
    { id: "4", name: `👑 ${fullLocation} 제휴 퀸즈홈테라피`, desc: "품격 있게 누리는 홈케어! 전문 힐러들의 체형 맞춤형 피로회복 특화 마사지 프로그램", phone: "0507-1280-3334", price: "맞춤 코스별 상이", image: "/shop4.jpg" },
    { id: "5", name: `🌙 ${fullLocation} 제휴 오늘밤테라피`, desc: "엄선된 우수 제휴점! 수도권 전지역 쾌적하고 편안한 방문 힐링 마사지", phone: "0507-1280-3223", price: "맞춤 코스별 상이", image: "/shop5.jpg" }
  ];
    ...
    <div className="bg-slate-50 text-slate-800 min-h-screen flex flex-col font-sans pb-16">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 w-full flex-1 space-y-8">
        <section className="relative rounded-3xl overflow-hidden border border-slate-200 shadow-sm bg-gradient-to-b from-slate-900 to-slate-800 p-8 text-white space-y-3">
          ...
          <h1 className="text-2xl md:text-3xl font-black">{fullLocation} 프리미엄 힐링 마사지 테라피 안내</h1>
          <p className="text-xs md:text-sm text-slate-300 max-w-xl leading-relaxed">
            {fullLocation} 고객님을 위한 엄선된 테라피 및 에스테틱 마사지 제휴 샵 안내입니다. 검증된 프로그램과 투명한 정보를 확인해 보세요.
          </p>
        </section>
