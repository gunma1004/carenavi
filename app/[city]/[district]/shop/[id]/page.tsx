...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const seed = `${locationPrefix}-${id}-carenavi-district-shop-mix`;
  ...
  const titleText = `${locationPrefix} 출장 ${shopModifiers[modIdx]} ${shopActionSuffixes[srvIdx]}`;
  const descText = `${locationPrefix} 출장 ${shopDescriptions[descIdx]}`;
