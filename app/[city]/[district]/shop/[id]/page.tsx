...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const seed = `${locationPrefix}-${id}-district-shop-short-seo`;
  ...
  const titleText = `${locationPrefix} ${shopShortModifiers[modIdx]}`;
  const descText = `${locationPrefix} 전문 홈케어 정보. ${shopDescriptions[descIdx]} 편안한 휴식을 누려보세요.`;
